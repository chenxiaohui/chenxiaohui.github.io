...
<!-- more -->
  ...
  * g:server_ip 开发机IP，这是你的源码所在机器的IP，保证能够无密码登录。
  ...
  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2013/three-log.png "log文件" "log文件")

  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2013/one-line.png "定位到对应的源码行c" "定位到对应的源码行")

  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2013/two-line.png "定位到对应的源码行cpp" "定位到对应的源码行")
