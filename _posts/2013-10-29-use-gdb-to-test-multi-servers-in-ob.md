...
<!-- more -->
  ...
  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2013/gdb_multi_server.png "图1：断点命中的情况" "图1：断点命中的情况")
  
  唯一的问题是gdb有时候会退出，如图2。感觉上是rpc超时了？

  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2013/gdb_quit.png "图2：gdb退出" "图2：gdb退出")
