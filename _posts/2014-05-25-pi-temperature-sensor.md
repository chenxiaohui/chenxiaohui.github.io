...
<!--more-->
  ...
  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2014/before.png "温度曲线" "温度曲线")

  开始的程序没有考虑求平均，不知道会不会有临时跳变的瞬间值。后来加了平均值之后发现多次取的结果是不一样，但是不清楚这个芯片采集的周期是多少。多次平均的结果如下所示：

  ![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2014/data.png "多次平均的结果" "多次平均的结果")
