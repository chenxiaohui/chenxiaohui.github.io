...
![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2015/moom_tooltip.png)

  然后我们配置窗口移动的功能，首先需要一个全局快捷键：

![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2015/moom_shortcut.png)

  之后可以设置按下全局快捷键之后上下左右键的功能。有移动窗口，半最大化窗口，缩小放大和移动窗口到一个屏幕。

![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2015/moom_config.png)

  这样就可以先按下全局快捷键，如下：

![](https://harrychen.oss-cn-beijing.aliyuncs.com/blog-images/2015/moom_press_shortcut.png)
